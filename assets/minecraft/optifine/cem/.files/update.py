...
outData = load(open("F:/Programming/GitHub/wynem/src/assets/json/cem_template_models.json"))
...
with open("F:/Programming/GitHub/wynem/src/assets/json/cem_template_models.json", "w") as outFile:
